Reaction rates and partition functions:
=======================================
Latest update: March 22, 2007

For the history of updates, see the file history.txt.
For details on the current update, see the file readme_update.txt
For details on reaclib.nosmo and winvn.nosmo, see below.
...
------------------------------------------------------
  ...
  ===================================================================
      ...
      temperatures. The partition functions are those given in
	ADNDT 75 (2000) 1.
